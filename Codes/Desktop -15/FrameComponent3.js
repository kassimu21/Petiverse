      ...
      <div className="top-right">
        <div className="user-actions">
          <div className="user-actions-icons">
            <img className="icons8" loading="lazy" alt="" src={icons} />
          ...
          <div className="user-actions-icons2">
            <img className="icons10" alt="" src={icons2} />
            <a className="messages">Messages</a>
          </div>
          <div className="user-actions-icons3">
            <img className="icons11" alt="" src={icons3} />
            <a className="profile">Profile</a>
          </div>
        </div>
        <div className="search">
          <div className="search-bar">
            <img className="icons12" alt="" src={icons4} />
            <input
