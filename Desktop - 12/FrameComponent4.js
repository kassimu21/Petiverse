        ...
        <div className="language-settings">
          <div className="language-option">
            <div className="language-select">
              ...
              <img className="icons26" alt="" src={icons} />
            </div>
